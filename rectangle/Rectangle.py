...
# ======================================================
mesh = Mesh()
with XDMFFile("rectangle_domain.xdmf") as infile:
    infile.read(mesh)

mvc_bnd = MeshValueCollection("size_t", mesh, mesh.topology().dim() - 1)
with XDMFFile("rectangle_boundaries.xdmf") as infile:
